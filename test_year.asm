...
_test_year:     file format elf32-i386
...
printf(1, "Note: Unix V6 was released in year %d\n", getyear());
    1015:	e8 49 03 00 00       	call   1363 <getyear>
    101a:	83 ec 04             	sub    $0x4,%esp
    101d:	50                   	push   %eax
    101e:	68 98 17 00 00       	push   $0x1798
    1023:	6a 01                	push   $0x1
    1025:	e8 06 04 00 00       	call   1430 <printf>

char *start = sbrk(0);
    102a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    1031:	e8 15 03 00 00       	call   134b <sbrk>
*start=100;
    1036:	c6 00 64             	movb   $0x64,(%eax)
...
printf(1, "Note: Unix V6 was released in year  %d\n", mprotect(start, 1));
    ...
    103b:	6a 01                	push   $0x1
    103d:	50                   	push   %eax
    103e:	e8 28 03 00 00       	call   136b <mprotect>
    1043:	83 c4 0c             	add    $0xc,%esp
    1046:	50                   	push   %eax
    1047:	68 c0 17 00 00       	push   $0x17c0
    104c:	6a 01                	push   $0x1
    104e:	e8 dd 03 00 00       	call   1430 <printf>
    exit();
    ...
    138c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    13b9:	0f b6 92 f0 17 00 00 	movzbl 0x17f0(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    15b4:	eb 1a                	jmp    15d0 <printf+0x1a0>
          s = "(null)";
    15b6:	bb e8 17 00 00       	mov    $0x17e8,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1605:	a1 98 1a 00 00       	mov    0x1a98,%eax
{
    ...
    1626:	73 10                	jae    1638 <free+0x38>
{
  ...
  freep = p;
    ...
    1651:	5b                   	pop    %ebx
  freep = p;
    1652:	a3 98 1a 00 00       	mov    %eax,0x1a98
}
    1657:	5e                   	pop    %esi
    1658:	5f                   	pop    %edi
    1659:	5d                   	pop    %ebp
  ...
  freep = p;
    167a:	a3 98 1a 00 00       	mov    %eax,0x1a98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16a0:	8b 3d 98 1a 00 00    	mov    0x1a98,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    16e9:	8b 3d 98 1a 00 00    	mov    0x1a98,%edi
  ...
  return freep;
    1717:	a1 98 1a 00 00       	mov    0x1a98,%eax
    ...
    1744:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    1747:	a3 98 1a 00 00       	mov    %eax,0x1a98
}
    ...
    base.s.ptr = freep = prevp = &base;
    1760:	c7 05 98 1a 00 00 9c 	movl   $0x1a9c,0x1a98
    1767:	1a 00 00 
    base.s.size = 0;
    176a:	bf 9c 1a 00 00       	mov    $0x1a9c,%edi
    base.s.ptr = freep = prevp = &base;
    176f:	c7 05 9c 1a 00 00 9c 	movl   $0x1a9c,0x1a9c
    1776:	1a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1779:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    177b:	c7 05 a0 1a 00 00 00 	movl   $0x0,0x1aa0
    1782:	00 00 00 
    if(p->s.size >= nunits){
