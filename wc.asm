    ...
    10aa:	31 db                	xor    %ebx,%ebx
{
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    1110:	01 cb                	add    %ecx,%ebx
      if(strchr(" \r\t\n\v", buf[i]))
    1112:	68 c8 18 00 00       	push   $0x18c8
  ...
  printf(1, "%d %d %d %s\n", l, w, c, name);
    ...
    1156:	53                   	push   %ebx
    1157:	68 de 18 00 00       	push   $0x18de
    115c:	6a 01                	push   $0x1
    ...
    116e:	50                   	push   %eax
    116f:	50                   	push   %eax
    1170:	68 ce 18 00 00       	push   $0x18ce
    1175:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    16e4:	eb 1a                	jmp    1700 <printf+0x1a0>
          s = "(null)";
    16e6:	bb ff 18 00 00       	mov    $0x18ff,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1735:	a1 00 1c 00 00       	mov    0x1c00,%eax
{
    ...
    1756:	73 10                	jae    1768 <free+0x38>
{
  ...
  freep = p;
    ...
    1781:	5b                   	pop    %ebx
  freep = p;
    1782:	a3 00 1c 00 00       	mov    %eax,0x1c00
}
    1787:	5e                   	pop    %esi
    1788:	5f                   	pop    %edi
    1789:	5d                   	pop    %ebp
  ...
  freep = p;
    17aa:	a3 00 1c 00 00       	mov    %eax,0x1c00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    17d0:	8b 3d 00 1c 00 00    	mov    0x1c00,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1819:	8b 3d 00 1c 00 00    	mov    0x1c00,%edi
  ...
  return freep;
    1847:	a1 00 1c 00 00       	mov    0x1c00,%eax
    ...
    1874:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    1877:	a3 00 1c 00 00       	mov    %eax,0x1c00
}
    ...
    1897:	1c 00 00 
    base.s.size = 0;
    189a:	bf 04 1c 00 00       	mov    $0x1c04,%edi
    base.s.ptr = freep = prevp = &base;
    189f:	c7 05 04 1c 00 00 04 	movl   $0x1c04,0x1c04
    18a6:	1c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    18a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    18ab:	c7 05 08 1c 00 00 00 	movl   $0x0,0x1c08
    18b2:	00 00 00 
    if(p->s.size >= nunits){
