...
main(int argc, char *argv[])
{
  ...
  for(i = 2; i < argc; i++){
    ...
    107a:	68 98 1a 00 00       	push   $0x1a98
    107f:	6a 01                	push   $0x1
  ...
  exit();
    ...
    1090:	51                   	push   %ecx
    1091:	51                   	push   %ecx
    1092:	68 78 1a 00 00       	push   $0x1a78
    1097:	6a 02                	push   $0x2
    ...
    123d:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
{
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m-1)) > 0){
    ...
    125d:	50                   	push   %eax
    125e:	8d 81 80 1e 00 00    	lea    0x1e80(%ecx),%eax
    1264:	50                   	push   %eax
    ...
    p = buf;
    127e:	bb 80 1e 00 00       	mov    $0x1e80,%ebx
    buf[m] = '\0';
    1283:	c6 81 80 1e 00 00 00 	movb   $0x0,0x1e80(%ecx)
    while((q = strchr(p, '\n')) != 0){
    ...
    if(p == buf)
    12e0:	81 fb 80 1e 00 00    	cmp    $0x1e80,%ebx
    ...
    12f5:	83 ec 04             	sub    $0x4,%esp
      m -= p - buf;
    12f8:	2d 80 1e 00 00       	sub    $0x1e80,%eax
    12fd:	29 c1                	sub    %eax,%ecx
      memmove(buf, p, m);
    12ff:	51                   	push   %ecx
    1300:	53                   	push   %ebx
    1301:	68 80 1e 00 00       	push   $0x1e80
      m -= p - buf;
...
00001653 <munprotect>:
SYSCALL(munprotect)
    1653:	b8 18 00 00 00       	mov    $0x18,%eax
    1658:	cd 40                	int    $0x40
    165a:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1894:	eb 1a                	jmp    18b0 <printf+0x1a0>
          s = "(null)";
    1896:	bb ae 1a 00 00       	mov    $0x1aae,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    18e5:	a1 60 1e 00 00       	mov    0x1e60,%eax
{
    ...
    1906:	73 10                	jae    1918 <free+0x38>
{
  ...
  freep = p;
    ...
    1931:	5b                   	pop    %ebx
  freep = p;
    1932:	a3 60 1e 00 00       	mov    %eax,0x1e60
}
    1937:	5e                   	pop    %esi
    1938:	5f                   	pop    %edi
    1939:	5d                   	pop    %ebp
  ...
  freep = p;
    195a:	a3 60 1e 00 00       	mov    %eax,0x1e60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1980:	8b 3d 60 1e 00 00    	mov    0x1e60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    19c9:	8b 3d 60 1e 00 00    	mov    0x1e60,%edi
  ...
  return freep;
    19f7:	a1 60 1e 00 00       	mov    0x1e60,%eax
    ...
    1a24:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    1a27:	a3 60 1e 00 00       	mov    %eax,0x1e60
}
    ...
    1a47:	1e 00 00 
    base.s.size = 0;
    1a4a:	bf 64 1e 00 00       	mov    $0x1e64,%edi
    base.s.ptr = freep = prevp = &base;
    1a4f:	c7 05 64 1e 00 00 64 	movl   $0x1e64,0x1e64
    1a56:	1e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1a59:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    1a5b:	c7 05 68 1e 00 00 00 	movl   $0x0,0x1e68
    1a62:	00 00 00 
    if(p->s.size >= nunits){
