...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 f3 7a 10 80 	movl   $0x80107af3,(%esp)
...
80100b3b:	e9 8c 00 00 00       	jmp    80100bcc <exec+0x14c>
    if(ph.type != ELF_PROG_LOAD)
80100b40:	83 bd 04 ff ff ff 01 	cmpl   $0x1,-0xfc(%ebp)
80100b47:	75 72                	jne    80100bbb <exec+0x13b>
    if(ph.memsz < ph.filesz)
80100b49:	8b 85 18 ff ff ff    	mov    -0xe8(%ebp),%eax
80100b4f:	3b 85 14 ff ff ff    	cmp    -0xec(%ebp),%eax
80100b55:	0f 82 8d 00 00 00    	jb     80100be8 <exec+0x168>
    if(ph.vaddr + ph.memsz < ph.vaddr)
80100b5b:	03 85 0c ff ff ff    	add    -0xf4(%ebp),%eax
80100b61:	0f 82 81 00 00 00    	jb     80100be8 <exec+0x168>
    if((vlimit = allocuvm(pgdir, vbase, vlimit, ph.vaddr + ph.memsz)) == 0)
80100b67:	50                   	push   %eax
80100b68:	ff b5 f0 fe ff ff    	pushl  -0x110(%ebp)
80100b6e:	68 00 10 00 00       	push   $0x1000
80100b73:	ff b5 f4 fe ff ff    	pushl  -0x10c(%ebp)
80100b79:	e8 72 61 00 00       	call   80106cf0 <allocuvm>
80100b7e:	83 c4 10             	add    $0x10,%esp
80100b81:	89 85 f0 fe ff ff    	mov    %eax,-0x110(%ebp)
80100b87:	85 c0                	test   %eax,%eax
80100b89:	74 5d                	je     80100be8 <exec+0x168>
    if(ph.vaddr % PGSIZE != 0)
80100b8b:	8b 85 0c ff ff ff    	mov    -0xf4(%ebp),%eax
80100b91:	a9 ff 0f 00 00       	test   $0xfff,%eax
80100b96:	75 50                	jne    80100be8 <exec+0x168>
    if(loaduvm(pgdir, (char*)ph.vaddr, ip, ph.off, ph.filesz) < 0)
80100b98:	83 ec 0c             	sub    $0xc,%esp
80100b9b:	ff b5 14 ff ff ff    	pushl  -0xec(%ebp)
80100ba1:	ff b5 08 ff ff ff    	pushl  -0xf8(%ebp)
80100ba7:	53                   	push   %ebx
80100ba8:	50                   	push   %eax
80100ba9:	ff b5 f4 fe ff ff    	pushl  -0x10c(%ebp)
80100baf:	e8 6c 60 00 00       	call   80106c20 <loaduvm>
80100bb4:	83 c4 20             	add    $0x20,%esp
80100bb7:	85 c0                	test   %eax,%eax
80100bb9:	78 2d                	js     80100be8 <exec+0x168>
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
80100bbb:	0f b7 85 50 ff ff ff 	movzwl -0xb0(%ebp),%eax
80100bc2:	83 c7 01             	add    $0x1,%edi
80100bc5:	83 c6 20             	add    $0x20,%esi
80100bc8:	39 f8                	cmp    %edi,%eax
80100bca:	7e 34                	jle    80100c00 <exec+0x180>
    if(readi(ip, (char*)&ph, off, sizeof(ph)) != sizeof(ph))
80100bcc:	8d 85 04 ff ff ff    	lea    -0xfc(%ebp),%eax
80100bd2:	6a 20                	push   $0x20
80100bd4:	56                   	push   %esi
80100bd5:	50                   	push   %eax
80100bd6:	53                   	push   %ebx
80100bd7:	e8 94 0e 00 00       	call   80101a70 <readi>
80100bdc:	83 c4 10             	add    $0x10,%esp
80100bdf:	83 f8 20             	cmp    $0x20,%eax
80100be2:	0f 84 58 ff ff ff    	je     80100b40 <exec+0xc0>
    freevm(pgdir);
80100be8:	83 ec 0c             	sub    $0xc,%esp
80100beb:	ff b5 f4 fe ff ff    	pushl  -0x10c(%ebp)
80100bf1:	e8 5a 62 00 00       	call   80106e50 <freevm>
  if(ip){
80100bf6:	83 c4 10             	add    $0x10,%esp
80100bf9:	e9 dc fe ff ff       	jmp    80100ada <exec+0x5a>
...
80100c28:	8b bd f4 fe ff ff    	mov    -0x10c(%ebp),%edi
80100c2e:	68 00 10 00 00       	push   $0x1000
80100c33:	57                   	push   %edi
80100c34:	e8 b7 60 00 00       	call   80106cf0 <allocuvm>
80100c39:	83 c4 20             	add    $0x20,%esp
80100c3c:	89 c6                	mov    %eax,%esi
80100c3e:	85 c0                	test   %eax,%eax
80100c40:	0f 84 92 00 00 00    	je     80100cd8 <exec+0x258>
  clearpteu(pgdir, (char*)(vlimit - 2*PGSIZE));
80100c46:	83 ec 08             	sub    $0x8,%esp
80100c49:	8d 80 00 e0 ff ff    	lea    -0x2000(%eax),%eax
  for(argc = 0; argv[argc]; argc++) {
80100c4f:	89 f3                	mov    %esi,%ebx
  clearpteu(pgdir, (char*)(vlimit - 2*PGSIZE));
80100c51:	50                   	push   %eax
80100c52:	57                   	push   %edi
  for(argc = 0; argv[argc]; argc++) {
80100c53:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(vlimit - 2*PGSIZE));
80100c55:	e8 16 63 00 00       	call   80106f70 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
80100c5a:	8b 45 0c             	mov    0xc(%ebp),%eax
80100c5d:	83 c4 10             	add    $0x10,%esp
80100c60:	8d 95 58 ff ff ff    	lea    -0xa8(%ebp),%edx
80100c66:	8b 00                	mov    (%eax),%eax
80100c68:	85 c0                	test   %eax,%eax
80100c6a:	0f 84 89 00 00 00    	je     80100cf9 <exec+0x279>
80100c70:	89 b5 f0 fe ff ff    	mov    %esi,-0x110(%ebp)
80100c76:	8b b5 f4 fe ff ff    	mov    -0x10c(%ebp),%esi
80100c7c:	eb 21                	jmp    80100c9f <exec+0x21f>
...
80100d7e:	8b 7f 08             	mov    0x8(%edi),%edi
  curproc->vbase = vbase;
80100d81:	c7 00 00 10 00 00    	movl   $0x1000,(%eax)
  curproc->pgdir = pgdir;
80100d87:	89 48 08             	mov    %ecx,0x8(%eax)
  curproc->vlimit = vlimit;
80100d8a:	89 c1                	mov    %eax,%ecx
80100d8c:	89 70 04             	mov    %esi,0x4(%eax)
  curproc->tf->eip = elf.entry;  // main
80100d8f:	8b 40 1c             	mov    0x1c(%eax),%eax
80100d92:	8b 95 3c ff ff ff    	mov    -0xc4(%ebp),%edx
80100d98:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100d9b:	8b 41 1c             	mov    0x1c(%ecx),%eax
80100d9e:	89 58 44             	mov    %ebx,0x44(%eax)
  switchuvm(curproc);
80100da1:	89 0c 24             	mov    %ecx,(%esp)
80100da4:	e8 e7 5c 00 00       	call   80106a90 <switchuvm>
  freevm(oldpgdir);
80100da9:	89 3c 24             	mov    %edi,(%esp)
80100dac:	e8 9f 60 00 00       	call   80106e50 <freevm>
  return 0;
...
80100dc3:	68 01 72 10 80       	push   $0x80107201
...
80100dd5:	e9 16 fd ff ff       	jmp    80100af0 <exec+0x70>
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
80100dda:	bf 00 10 00 00       	mov    $0x1000,%edi
80100ddf:	be 00 30 00 00       	mov    $0x3000,%esi
...
80100dfa:	68 0d 72 10 80       	push   $0x8010720d
...
80100ebf:	68 14 72 10 80       	push   $0x80107214
...
80100f9c:	68 1c 72 10 80       	push   $0x8010721c
...
8010108a:	68 26 72 10 80       	push   $0x80107226
...
80101173:	68 2f 72 10 80       	push   $0x8010722f
...
801011a9:	68 35 72 10 80       	push   $0x80107235
...
80101227:	68 3f 72 10 80       	push   $0x8010723f
...
801012e4:	68 52 72 10 80       	push   $0x80107252
...
80101432:	68 68 72 10 80       	push   $0x80107268
...
801014fb:	68 78 72 10 80       	push   $0x80107278
...
80101560:	68 8b 72 10 80       	push   $0x8010728b
...
8010157b:	68 92 72 10 80       	push   $0x80107292
...
801015d1:	68 f8 72 10 80       	push   $0x801072f8
...
801016a3:	68 98 72 10 80       	push   $0x80107298
...
8010182d:	68 b0 72 10 80       	push   $0x801072b0
80101832:	e8 59 eb ff ff       	call   80100390 <panic>
    panic("ilock");
80101837:	83 ec 0c             	sub    $0xc,%esp
8010183a:	68 aa 72 10 80       	push   $0x801072aa
...
8010188b:	68 bf 72 10 80       	push   $0x801072bf
...
80101d5a:	68 d9 72 10 80       	push   $0x801072d9
80101d5f:	e8 2c e6 ff ff       	call   80100390 <panic>
    panic("dirlookup not DIR");
80101d64:	83 ec 0c             	sub    $0xc,%esp
80101d67:	68 c7 72 10 80       	push   $0x801072c7
...
80102023:	68 e8 72 10 80       	push   $0x801072e8
80102028:	e8 63 e3 ff ff       	call   80100390 <panic>
    panic("dirlink");
8010202d:	83 ec 0c             	sub    $0xc,%esp
80102030:	68 ca 78 10 80       	push   $0x801078ca
...
8010213b:	68 54 73 10 80       	push   $0x80107354
80102140:	e8 4b e2 ff ff       	call   80100390 <panic>
    panic("idestart");
80102145:	83 ec 0c             	sub    $0xc,%esp
80102148:	68 4b 73 10 80       	push   $0x8010734b
...
8010216a:	68 66 73 10 80       	push   $0x80107366
...
801023de:	68 b4 73 10 80       	push   $0x801073b4
...
80102513:	68 e6 73 10 80       	push   $0x801073e6
...
8010257f:	68 ec 73 10 80       	push   $0x801073ec
...
80102cae:	68 20 76 10 80       	push   $0x80107620
...
80102f07:	68 24 76 10 80       	push   $0x80107624
...
80102fd1:	68 33 76 10 80       	push   $0x80107633
80102fd6:	e8 b5 d3 ff ff       	call   80100390 <panic>
    panic("log_write outside of trans");
80102fdb:	83 ec 0c             	sub    $0xc,%esp
80102fde:	68 49 76 10 80       	push   $0x80107649
...
80103008:	68 64 76 10 80       	push   $0x80107664
8010300d:	e8 9e d6 ff ff       	call   801006b0 <cprintf>
  idtinit();       // load idt register
80103012:	e8 89 29 00 00       	call   801059a0 <idtinit>
...
80103037:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
8010303a:	e8 31 3a 00 00       	call   80106a70 <switchkvm>
  seginit();
8010303f:	e8 9c 39 00 00       	call   801069e0 <seginit>
  lapicinit();
...
80103098:	e8 03 2c 00 00       	call   80105ca0 <uartinit>
  pinit();         // process table
8010309d:	e8 1e 08 00 00       	call   801038c0 <pinit>
  tvinit();        // trap vectors
801030a2:	e8 79 28 00 00       	call   80105920 <tvinit>
  binit();         // buffer cache
...
801030be:	68 90 a4 10 80       	push   $0x8010a490
...
801031ae:	68 78 76 10 80       	push   $0x80107678
...
8010326a:	68 7d 76 10 80       	push   $0x8010767d
...
801033c3:	68 82 76 10 80       	push   $0x80107682
801033c8:	e8 c3 cf ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
801033cd:	83 ec 0c             	sub    $0xc,%esp
801033d0:	68 9c 76 10 80       	push   $0x8010769c
...
80103474:	00 00 00 
  initlock(&p->lock, "pipe");
80103477:	68 bb 76 10 80       	push   $0x801076bb
...
801039c1:	0f 84 c4 00 00 00    	je     80103a8b <userinit+0xeb>
  inituvm(p->pgdir, _binary_initcode_start, (int)_binary_initcode_size);
801039c7:	83 ec 04             	sub    $0x4,%esp
801039ca:	68 30 00 00 00       	push   $0x30
...
801039dd:	c7 03 00 10 00 00    	movl   $0x1000,(%ebx)
  p->vlimit = 2*PGSIZE;
801039e3:	c7 43 04 00 20 00 00 	movl   $0x2000,0x4(%ebx)
  memset(p->tf, 0, sizeof(*p->tf));
801039ea:	6a 4c                	push   $0x4c
801039ec:	6a 00                	push   $0x0
801039ee:	ff 73 1c             	pushl  0x1c(%ebx)
801039f1:	e8 9a 0c 00 00       	call   80104690 <memset>
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
801039f6:	8b 43 1c             	mov    0x1c(%ebx),%eax
801039f9:	ba 1b 00 00 00       	mov    $0x1b,%edx
  safestrcpy(p->name, "initcode", sizeof(p->name));
801039fe:	83 c4 0c             	add    $0xc,%esp
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103a01:	b9 23 00 00 00       	mov    $0x23,%ecx
  p->tf->cs = (SEG_UCODE << 3) | DPL_USER;
80103a06:	66 89 50 3c          	mov    %dx,0x3c(%eax)
  p->tf->ds = (SEG_UDATA << 3) | DPL_USER;
80103a0a:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103a0d:	66 89 48 2c          	mov    %cx,0x2c(%eax)
  p->tf->es = p->tf->ds;
80103a11:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103a14:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103a18:	66 89 50 28          	mov    %dx,0x28(%eax)
  p->tf->ss = p->tf->ds;
80103a1c:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103a1f:	0f b7 50 2c          	movzwl 0x2c(%eax),%edx
80103a23:	66 89 50 48          	mov    %dx,0x48(%eax)
  p->tf->eflags = FL_IF;
80103a27:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103a2a:	c7 40 40 00 02 00 00 	movl   $0x200,0x40(%eax)
  p->tf->esp = 2*PGSIZE;
80103a31:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103a34:	c7 40 44 00 20 00 00 	movl   $0x2000,0x44(%eax)
  p->tf->eip = PGSIZE;  // beginning of initcode.S
80103a3b:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103a3e:	c7 40 38 00 10 00 00 	movl   $0x1000,0x38(%eax)
  safestrcpy(p->name, "initcode", sizeof(p->name));
80103a45:	8d 43 70             	lea    0x70(%ebx),%eax
80103a48:	6a 10                	push   $0x10
80103a4a:	68 f0 76 10 80       	push   $0x801076f0
80103a4f:	50                   	push   %eax
80103a50:	e8 fb 0d 00 00       	call   80104850 <safestrcpy>
  p->cwd = namei("/");
80103a55:	c7 04 24 f9 76 10 80 	movl   $0x801076f9,(%esp)
80103a5c:	e8 df e5 ff ff       	call   80102040 <namei>
80103a61:	89 43 6c             	mov    %eax,0x6c(%ebx)
  acquire(&ptable.lock);
80103a64:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a6b:	e8 10 0b 00 00       	call   80104580 <acquire>
  p->state = RUNNABLE;
80103a70:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
  release(&ptable.lock);
80103a77:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a7e:	e8 bd 0b 00 00       	call   80104640 <release>
}
...
80103a8e:	68 d7 76 10 80       	push   $0x801076d7
80103a93:	e8 f8 c8 ff ff       	call   80100390 <panic>
...
80103ad1:	e8 ba 2f 00 00       	call   80106a90 <switchuvm>
  return 0;
...
80103ae8:	01 c6                	add    %eax,%esi
80103aea:	56                   	push   %esi
80103aeb:	50                   	push   %eax
80103aec:	ff 33                	pushl  (%ebx)
80103aee:	ff 73 08             	pushl  0x8(%ebx)
80103af1:	e8 fa 31 00 00       	call   80106cf0 <allocuvm>
80103af6:	83 c4 10             	add    $0x10,%esp
80103af9:	85 c0                	test   %eax,%eax
80103afb:	75 cd                	jne    80103aca <growproc+0x2a>
      return -1;
80103afd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103b02:	eb d7                	jmp    80103adb <growproc+0x3b>
...
80103b5a:	ff 33                	pushl  (%ebx)
80103b5c:	ff 73 08             	pushl  0x8(%ebx)
80103b5f:	e8 3c 34 00 00       	call   80106fa0 <copyuvm>
80103b64:	83 c4 10             	add    $0x10,%esp
80103b67:	89 47 08             	mov    %eax,0x8(%edi)
80103b6a:	85 c0                	test   %eax,%eax
80103b6c:	0f 84 aa 00 00 00    	je     80103c1c <fork+0xfc>
  np->vbase = curproc->vbase;
80103b72:	8b 03                	mov    (%ebx),%eax
80103b74:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80103b77:	89 01                	mov    %eax,(%ecx)
...
80103c1a:	eb ef                	jmp    80103c0b <fork+0xeb>
    kfree(np->kstack);
80103c1c:	8b 7d e4             	mov    -0x1c(%ebp),%edi
80103c1f:	83 ec 0c             	sub    $0xc,%esp
    return -1;
80103c22:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
    kfree(np->kstack);
80103c27:	ff 77 0c             	pushl  0xc(%edi)
80103c2a:	e8 51 e8 ff ff       	call   80102480 <kfree>
    np->kstack = 0;
80103c2f:	c7 47 0c 00 00 00 00 	movl   $0x0,0xc(%edi)
    return -1;
80103c36:	83 c4 10             	add    $0x10,%esp
    np->state = UNUSED;
80103c39:	c7 47 10 00 00 00 00 	movl   $0x0,0x10(%edi)
    return -1;
...
80103cb2:	e8 fc 0b 00 00       	call   801048b3 <swtch>
      switchkvm();
80103cb7:	e8 b4 2d 00 00       	call   80106a70 <switchkvm>
      c->proc = 0;
...
8010409a:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        freevm(p->pgdir);
801040a1:	e8 aa 2d 00 00       	call   80106e50 <freevm>
        release(&ptable.lock);
...
80104213:	68 f3 7a 10 80       	push   $0x80107af3
...
801048e3:	8b 50 04             	mov    0x4(%eax),%edx
801048e6:	39 da                	cmp    %ebx,%edx
801048e8:	76 26                	jbe    80104910 <fetchint+0x40>
801048ea:	8d 4b 04             	lea    0x4(%ebx),%ecx
801048ed:	39 ca                	cmp    %ecx,%edx
801048ef:	72 1f                	jb     80104910 <fetchint+0x40>
    || addr < curproc->vbase || addr+4 <= curproc->vbase)
801048f1:	8b 00                	mov    (%eax),%eax
801048f3:	39 d8                	cmp    %ebx,%eax
801048f5:	77 19                	ja     80104910 <fetchint+0x40>
801048f7:	39 c1                	cmp    %eax,%ecx
801048f9:	76 15                	jbe    80104910 <fetchint+0x40>
    return -1;
  *ip = *(int*)(addr);
801048fb:	8b 45 0c             	mov    0xc(%ebp),%eax
801048fe:	8b 13                	mov    (%ebx),%edx
80104900:	89 10                	mov    %edx,(%eax)
  return 0;
80104902:	31 c0                	xor    %eax,%eax
}
...
80104915:	eb ed                	jmp    80104904 <fetchint+0x34>
...
80104933:	39 58 04             	cmp    %ebx,0x4(%eax)
80104936:	76 30                	jbe    80104968 <fetchstr+0x48>
80104938:	39 18                	cmp    %ebx,(%eax)
8010493a:	77 2c                	ja     80104968 <fetchstr+0x48>
    return -1;
  *pp = (char*)addr;
8010493c:	8b 55 0c             	mov    0xc(%ebp),%edx
8010493f:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->vlimit;
80104941:	8b 50 04             	mov    0x4(%eax),%edx
  for(s = *pp; s < ep; s++){
80104944:	39 d3                	cmp    %edx,%ebx
80104946:	73 20                	jae    80104968 <fetchstr+0x48>
80104948:	89 d8                	mov    %ebx,%eax
8010494a:	eb 0b                	jmp    80104957 <fetchstr+0x37>
...
80104994:	89 75 0c             	mov    %esi,0xc(%ebp)
80104997:	8b 40 1c             	mov    0x1c(%eax),%eax
8010499a:	8b 40 44             	mov    0x44(%eax),%eax
8010499d:	8d 44 98 04          	lea    0x4(%eax,%ebx,4),%eax
}
801049a1:	5b                   	pop    %ebx
801049a2:	5e                   	pop    %esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801049a3:	89 45 08             	mov    %eax,0x8(%ebp)
}
801049a6:	5d                   	pop    %ebp
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801049a7:	e9 24 ff ff ff       	jmp    801048d0 <fetchint>
...
801049d0:	e8 ab ff ff ff       	call   80104980 <argint>
    return -1;
  if(size < 0 || (uint)i >= curproc->vlimit || (uint)i+size > curproc->vlimit
801049d5:	83 c4 10             	add    $0x10,%esp
801049d8:	85 c0                	test   %eax,%eax
801049da:	78 34                	js     80104a10 <argptr+0x60>
801049dc:	85 db                	test   %ebx,%ebx
801049de:	78 30                	js     80104a10 <argptr+0x60>
801049e0:	8b 56 04             	mov    0x4(%esi),%edx
801049e3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049e6:	39 c2                	cmp    %eax,%edx
801049e8:	76 26                	jbe    80104a10 <argptr+0x60>
801049ea:	01 c3                	add    %eax,%ebx
801049ec:	39 da                	cmp    %ebx,%edx
801049ee:	72 20                	jb     80104a10 <argptr+0x60>
    || (uint)i < curproc->vbase || (uint)i+size <= curproc->vbase)
801049f0:	8b 16                	mov    (%esi),%edx
801049f2:	39 d3                	cmp    %edx,%ebx
801049f4:	76 1a                	jbe    80104a10 <argptr+0x60>
801049f6:	39 d0                	cmp    %edx,%eax
801049f8:	72 16                	jb     80104a10 <argptr+0x60>
    return -1;
  *pp = (char*)i;
801049fa:	8b 55 0c             	mov    0xc(%ebp),%edx
801049fd:	89 02                	mov    %eax,(%edx)
  return 0;
...
80104a15:	eb ea                	jmp    80104a01 <argptr+0x51>
...
80104a31:	e8 4a ff ff ff       	call   80104980 <argint>
...
80104a46:	e8 d5 fe ff ff       	call   80104920 <fetchstr>
...
80104a7b:	83 fa 17             	cmp    $0x17,%edx
...
80104c04:	68 c0 78 10 80       	push   $0x801078c0
...
80104c1c:	68 bf 78 10 80       	push   $0x801078bf
...
80104c31:	68 b3 78 10 80       	push   $0x801078b3
...
80104c4f:	68 c2 78 10 80       	push   $0x801078c2
80104c54:	e8 37 b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c59:	83 ec 0c             	sub    $0xc,%esp
80104c5c:	68 a4 78 10 80       	push   $0x801078a4
...
80104d51:	e8 2a fc ff ff       	call   80104980 <argint>
...
80104d69:	e8 42 fc ff ff       	call   801049b0 <argptr>
...
80104dc1:	e8 ba fb ff ff       	call   80104980 <argint>
...
80104dd9:	e8 d2 fb ff ff       	call   801049b0 <argptr>
...
80104e83:	e8 28 fb ff ff       	call   801049b0 <argptr>
...
8010504d:	58                   	pop    %eax
8010504e:	5a                   	pop    %edx
8010504f:	68 c0 78 10 80       	push   $0x801078c0
...
80105068:	68 bf 78 10 80       	push   $0x801078bf
...
8010520c:	e8 6f f7 ff ff       	call   80104980 <argint>
...
801053bd:	e8 be f5 ff ff       	call   80104980 <argint>
  if((argstr(0, &path)) < 0 ||
...
801053d2:	e8 a9 f5 ff ff       	call   80104980 <argint>
     argint(1, &major) < 0 ||
...
80105515:	e8 66 f4 ff ff       	call   80104980 <argint>
...
80105580:	e8 9b f3 ff ff       	call   80104920 <fetchstr>
...
801055f5:	e8 b6 f3 ff ff       	call   801049b0 <argptr>
...
80105710:	e8 6b f2 ff ff       	call   80104980 <argint>
...
80105747:	83 ec 14             	sub    $0x14,%esp
  cprintf("Helloooooooo\n");
8010574a:	68 05 79 10 80       	push   $0x80107905
8010574f:	e8 5c af ff ff       	call   801006b0 <cprintf>
  return 12;
}
80105754:	b8 0c 00 00 00       	mov    $0xc,%eax
80105759:	c9                   	leave  
8010575a:	c3                   	ret    
8010575b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010575f:	90                   	nop

80105760 <sys_mprotect>:
...
80105767:	83 ec 14             	sub    $0x14,%esp
  cprintf("Helloooooooo\n");
8010576a:	68 05 79 10 80       	push   $0x80107905
8010576f:	e8 3c af ff ff       	call   801006b0 <cprintf>
  return 12;
}
80105774:	b8 0c 00 00 00       	mov    $0xc,%eax
80105779:	c9                   	leave  
8010577a:	c3                   	ret    
8010577b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010577f:	90                   	nop

80105780 <sys_munprotect>:
80105780:	f3 0f 1e fb          	endbr32 
80105784:	55                   	push   %ebp
80105785:	89 e5                	mov    %esp,%ebp
80105787:	83 ec 14             	sub    $0x14,%esp
8010578a:	68 05 79 10 80       	push   $0x80107905
8010578f:	e8 1c af ff ff       	call   801006b0 <cprintf>
80105794:	b8 0c 00 00 00       	mov    $0xc,%eax
80105799:	c9                   	leave  
8010579a:	c3                   	ret    
...
801057af:	8b 40 14             	mov    0x14(%eax),%eax
}
801057b2:	c9                   	leave  
801057b3:	c3                   	ret    
...
801057e2:	83 ec 0c             	sub    $0xc,%esp
  addr = myproc()->vlimit;
801057e5:	8b 58 04             	mov    0x4(%eax),%ebx
  if(growproc(n) < 0)
801057e8:	ff 75 f4             	pushl  -0xc(%ebp)
801057eb:	e8 b0 e2 ff ff       	call   80103aa0 <growproc>
801057f0:	83 c4 10             	add    $0x10,%esp
801057f3:	85 c0                	test   %eax,%eax
801057f5:	78 09                	js     80105800 <sys_sbrk+0x40>
    return -1;
  return addr;
}
801057f7:	89 d8                	mov    %ebx,%eax
801057f9:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801057fc:	c9                   	leave  
801057fd:	c3                   	ret    
801057fe:	66 90                	xchg   %ax,%ax
    return -1;
80105800:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80105805:	eb f0                	jmp    801057f7 <sys_sbrk+0x37>
...
80105821:	e8 5a f1 ff ff       	call   80104980 <argint>
...
80105839:	e8 42 ed ff ff       	call   80104580 <acquire>
  ticks0 = ticks;
...
8010585d:	e8 de e6 ff ff       	call   80103f40 <sleep>
  while(ticks - ticks0 < n){
...
80105885:	e8 b6 ed ff ff       	call   80104640 <release>
  }
  release(&tickslock);
  return 0;
}
...
801058a8:	e8 93 ed ff ff       	call   80104640 <release>
  return 0;
...
8010596e:	00 00 ef 
  initlock(&tickslock, "time");
80105971:	68 13 79 10 80       	push   $0x80107913
...
801059af:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059b3:	b8 a0 4d 11 80       	mov    $0x80114da0,%eax
...
801059f4:	3e ff 24 85 bc 79 10 	notrack jmp *-0x7fef8644(,%eax,4)
801059fb:	80 
    lapiceoi();
    break;
...
80105a4a:	83 c6 70             	add    $0x70,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105a4d:	56                   	push   %esi
80105a4e:	ff 70 14             	pushl  0x14(%eax)
80105a51:	68 78 79 10 80       	push   $0x80107978
...
80105a63:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
  }
...
80105a78:	8b 50 28             	mov    0x28(%eax),%edx
...
80105a9e:	83 78 10 04          	cmpl   $0x4,0x10(%eax)
...
80105ab6:	8b 40 28             	mov    0x28(%eax),%eax
...
80105ad5:	c3                   	ret    
    ideintr();
80105ad6:	e8 15 c7 ff ff       	call   801021f0 <ideintr>
    lapiceoi();
80105adb:	e8 f0 cd ff ff       	call   801028d0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80105af7:	68 60 4d 11 80       	push   $0x80114d60
80105afc:	e8 7f ea ff ff       	call   80104580 <acquire>
      wakeup(&ticks);
80105b01:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
80105b08:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
80105b0f:	e8 ec e5 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105b14:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105b1b:	e8 20 eb ff ff       	call   80104640 <release>
80105b20:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105b23:	eb b6                	jmp    80105adb <trap+0x10b>
    kbdintr();
80105b25:	e8 66 cc ff ff       	call   80102790 <kbdintr>
    lapiceoi();
80105b2a:	e8 a1 cd ff ff       	call   801028d0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80105b41:	e8 4a 02 00 00       	call   80105d90 <uartintr>
    lapiceoi();
80105b46:	e8 85 cd ff ff       	call   801028d0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80105b6c:	68 20 79 10 80       	push   $0x80107920
80105b71:	e8 3a ab ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105b76:	e8 55 cd ff ff       	call   801028d0 <lapiceoi>
    break;
...
80105b94:	0f 85 0e ff ff ff    	jne    80105aa8 <trap+0xd8>
    yield();
80105b9a:	e8 51 e3 ff ff       	call   80103ef0 <yield>
...
80105bd7:	5d                   	pop    %ebp
      exit();
80105bd8:	e9 d3 e1 ff ff       	jmp    80103db0 <exit>
80105bdd:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105be0:	e8 cb e1 ff ff       	call   80103db0 <exit>
...
80105c08:	68 44 79 10 80       	push   $0x80107944
80105c0d:	e8 9e aa ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105c12:	83 c4 14             	add    $0x14,%esp
80105c15:	68 18 79 10 80       	push   $0x80107918
...
80105c75:	e8 76 cc ff ff       	call   801028f0 <microdelay>
...
80105d13:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105d18:	bb 3c 7a 10 80       	mov    $0x80107a3c,%ebx
  ioapicenable(IRQ_COM1, 0);
80105d1d:	6a 00                	push   $0x0
80105d1f:	6a 04                	push   $0x4
80105d21:	e8 1a c7 ff ff       	call   80102440 <ioapicenable>
...
80106864:	e8 d7 bd ff ff       	call   80102640 <kalloc>
...
8010691d:	68 44 7a 10 80       	push   $0x80107a44
...
80106998:	e8 e3 ba ff ff       	call   80102480 <kfree>
      *pte = 0;
...
801069d3:	68 e6 73 10 80       	push   $0x801073e6
...
80106a74:	a1 a4 55 11 80       	mov    0x801155a4,%eax
...
80106b3a:	8b 5e 0c             	mov    0xc(%esi),%ebx
...
80106b5c:	8b 46 08             	mov    0x8(%esi),%eax
...
80106bbf:	77 4e                	ja     80106c0f <inituvm+0x6f>
  mem = kalloc();
80106bc1:	e8 7a ba ff ff       	call   80102640 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106bd3:	e8 b8 da ff ff       	call   80104690 <memset>
...
80106be7:	ba 00 10 00 00       	mov    $0x1000,%edx
80106bec:	50                   	push   %eax
80106bed:	89 f8                	mov    %edi,%eax
80106bef:	e8 ac fc ff ff       	call   801068a0 <mappages>
  memmove(mem, init, sz);
80106bf4:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106bf7:	89 75 10             	mov    %esi,0x10(%ebp)
80106bfa:	83 c4 10             	add    $0x10,%esp
80106bfd:	89 5d 08             	mov    %ebx,0x8(%ebp)
80106c00:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
80106c09:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c0a:	e9 21 db ff ff       	jmp    80104730 <memmove>
    panic("inituvm: more than a page");
80106c0f:	83 ec 0c             	sub    $0xc,%esp
80106c12:	68 89 7a 10 80       	push   $0x80107a89
...
80106c9e:	e8 cd ad ff ff       	call   80101a70 <readi>
...
80106cfd:	8b 45 14             	mov    0x14(%ebp),%eax
{
...
80106d08:	0f 88 b2 00 00 00    	js     80106dc0 <allocuvm+0xd0>
  if(newvlimit < oldvlimit)
80106d0e:	3b 45 10             	cmp    0x10(%ebp),%eax
    return oldvlimit;
80106d11:	8b 45 10             	mov    0x10(%ebp),%eax
  if(newvlimit < oldvlimit)
...
80106d26:	39 75 14             	cmp    %esi,0x14(%ebp)
...
80106d3b:	e8 50 d9 ff ff       	call   80104690 <memset>
...
80106d66:	39 75 14             	cmp    %esi,0x14(%ebp)
80106d69:	76 48                	jbe    80106db3 <allocuvm+0xc3>
    mem = kalloc();
80106d6b:	e8 d0 b8 ff ff       	call   80102640 <kalloc>
...
80106d79:	68 c1 7a 10 80       	push   $0x80107ac1
80106d7e:	e8 2d 99 ff ff       	call   801006b0 <cprintf>
  if(newvlimit >= oldvlimit)
80106d83:	8b 45 10             	mov    0x10(%ebp),%eax
80106d86:	83 c4 10             	add    $0x10,%esp
80106d89:	39 45 14             	cmp    %eax,0x14(%ebp)
80106d8c:	74 32                	je     80106dc0 <allocuvm+0xd0>
80106d8e:	8b 55 14             	mov    0x14(%ebp),%edx
...
80106ddb:	68 d9 7a 10 80       	push   $0x80107ad9
80106de0:	e8 cb 98 ff ff       	call   801006b0 <cprintf>
  if(newvlimit >= oldvlimit)
80106de5:	8b 45 10             	mov    0x10(%ebp),%eax
80106de8:	83 c4 10             	add    $0x10,%esp
80106deb:	39 45 14             	cmp    %eax,0x14(%ebp)
80106dee:	74 0c                	je     80106dfc <allocuvm+0x10c>
80106df0:	8b 55 14             	mov    0x14(%ebp),%edx
...
80106e00:	e8 7b b6 ff ff       	call   80102480 <kfree>
      return 0;
...
80106e9e:	e8 dd b5 ff ff       	call   80102480 <kfree>
...
80106eb3:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106eb4:	e9 c7 b5 ff ff       	jmp    80102480 <kfree>
    panic("freevm: no pgdir");
80106eb9:	83 ec 0c             	sub    $0xc,%esp
80106ebc:	68 f5 7a 10 80       	push   $0x80107af5
...
80106ed9:	e8 62 b7 ff ff       	call   80102640 <kalloc>
...
80106ef4:	e8 97 d7 ff ff       	call   80104690 <memset>
...
80106f5f:	a3 a4 55 11 80       	mov    %eax,0x801155a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f93:	68 06 7b 10 80       	push   $0x80107b06
...
80106fb7:	0f 84 a3 00 00 00    	je     80107060 <copyuvm+0xc0>
    return 0;
  for(i = PGSIZE; i < vlimit; i += PGSIZE){
80106fbd:	81 7d 10 00 10 00 00 	cmpl   $0x1000,0x10(%ebp)
80106fc4:	0f 86 96 00 00 00    	jbe    80107060 <copyuvm+0xc0>
80106fca:	be 00 10 00 00       	mov    $0x1000,%esi
80106fcf:	eb 49                	jmp    8010701a <copyuvm+0x7a>
...
80106fdb:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80106fe1:	68 00 10 00 00       	push   $0x1000
80106fe6:	57                   	push   %edi
80106fe7:	50                   	push   %eax
80106fe8:	e8 43 d7 ff ff       	call   80104730 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106fed:	58                   	pop    %eax
80106fee:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106ff4:	5a                   	pop    %edx
80106ff5:	ff 75 e4             	pushl  -0x1c(%ebp)
80106ff8:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106ffd:	89 f2                	mov    %esi,%edx
80106fff:	50                   	push   %eax
80107000:	8b 45 e0             	mov    -0x20(%ebp),%eax
80107003:	e8 98 f8 ff ff       	call   801068a0 <mappages>
80107008:	83 c4 10             	add    $0x10,%esp
8010700b:	85 c0                	test   %eax,%eax
8010700d:	78 61                	js     80107070 <copyuvm+0xd0>
  for(i = PGSIZE; i < vlimit; i += PGSIZE){
8010700f:	81 c6 00 10 00 00    	add    $0x1000,%esi
80107015:	39 75 10             	cmp    %esi,0x10(%ebp)
80107018:	76 46                	jbe    80107060 <copyuvm+0xc0>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
8010701a:	8b 45 08             	mov    0x8(%ebp),%eax
8010701d:	31 c9                	xor    %ecx,%ecx
8010701f:	89 f2                	mov    %esi,%edx
80107021:	e8 fa f7 ff ff       	call   80106820 <walkpgdir>
80107026:	85 c0                	test   %eax,%eax
80107028:	74 61                	je     8010708b <copyuvm+0xeb>
    if(!(*pte & PTE_P))
8010702a:	8b 00                	mov    (%eax),%eax
8010702c:	a8 01                	test   $0x1,%al
8010702e:	74 4e                	je     8010707e <copyuvm+0xde>
    pa = PTE_ADDR(*pte);
80107030:	89 c7                	mov    %eax,%edi
    flags = PTE_FLAGS(*pte);
80107032:	25 ff 0f 00 00       	and    $0xfff,%eax
80107037:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
8010703a:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107040:	e8 fb b5 ff ff       	call   80102640 <kalloc>
80107045:	89 c3                	mov    %eax,%ebx
80107047:	85 c0                	test   %eax,%eax
80107049:	75 8d                	jne    80106fd8 <copyuvm+0x38>
    }
  }
  return d;
...
8010704e:	ff 75 e0             	pushl  -0x20(%ebp)
80107051:	e8 fa fd ff ff       	call   80106e50 <freevm>
  return 0;
80107056:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
8010705d:	83 c4 10             	add    $0x10,%esp
}
80107060:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80107074:	e8 07 b4 ff ff       	call   80102480 <kfree>
      goto bad;
80107079:	83 c4 10             	add    $0x10,%esp
8010707c:	eb cd                	jmp    8010704b <copyuvm+0xab>
      panic("copyuvm: page not present");
8010707e:	83 ec 0c             	sub    $0xc,%esp
80107081:	68 2a 7b 10 80       	push   $0x80107b2a
80107086:	e8 05 93 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
8010708b:	83 ec 0c             	sub    $0xc,%esp
8010708e:	68 10 7b 10 80       	push   $0x80107b10
...
801070b2:	e8 69 f7 ff ff       	call   80106820 <walkpgdir>
  if((*pte & PTE_P) == 0)
