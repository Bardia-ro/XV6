    ...
    101f:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "stressfs starting\n");
    102f:	68 78 18 00 00       	push   $0x1878
    1034:	6a 01                	push   $0x1
  char path[] = "stressfs0";
  ...
  printf(1, "write %d\n", i);
    1085:	68 8b 18 00 00       	push   $0x188b
    108a:	6a 01                	push   $0x1
...
//    printf(fd, "%d\n", i);
  ...
  printf(1, "read\n");
    10d8:	58                   	pop    %eax
    10d9:	5a                   	pop    %edx
    10da:	68 95 18 00 00       	push   $0x1895
    10df:	6a 01                	push   $0x1
...
00001453 <munprotect>:
SYSCALL(munprotect)
    1453:	b8 18 00 00 00       	mov    $0x18,%eax
    1458:	cd 40                	int    $0x40
    145a:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1694:	eb 1a                	jmp    16b0 <printf+0x1a0>
          s = "(null)";
    1696:	bb 9b 18 00 00       	mov    $0x189b,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    16e5:	a1 5c 1b 00 00       	mov    0x1b5c,%eax
{
    ...
    1706:	73 10                	jae    1718 <free+0x38>
{
  ...
  freep = p;
    ...
    1731:	5b                   	pop    %ebx
  freep = p;
    1732:	a3 5c 1b 00 00       	mov    %eax,0x1b5c
}
    1737:	5e                   	pop    %esi
    1738:	5f                   	pop    %edi
    1739:	5d                   	pop    %ebp
  ...
  freep = p;
    175a:	a3 5c 1b 00 00       	mov    %eax,0x1b5c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1780:	8b 3d 5c 1b 00 00    	mov    0x1b5c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    17c9:	8b 3d 5c 1b 00 00    	mov    0x1b5c,%edi
  ...
  return freep;
    17f7:	a1 5c 1b 00 00       	mov    0x1b5c,%eax
    ...
    1824:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    1827:	a3 5c 1b 00 00       	mov    %eax,0x1b5c
}
    ...
    base.s.ptr = freep = prevp = &base;
    1840:	c7 05 5c 1b 00 00 60 	movl   $0x1b60,0x1b5c
    1847:	1b 00 00 
    base.s.size = 0;
    184a:	bf 60 1b 00 00       	mov    $0x1b60,%edi
    base.s.ptr = freep = prevp = &base;
    184f:	c7 05 60 1b 00 00 60 	movl   $0x1b60,0x1b60
    1856:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1859:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    185b:	c7 05 64 1b 00 00 00 	movl   $0x0,0x1b64
    1862:	00 00 00 
    if(p->s.size >= nunits){
