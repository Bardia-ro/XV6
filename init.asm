...
main(void)
{
  ...
  if(open("console", O_RDWR) < 0){
    ...
    1016:	6a 02                	push   $0x2
    1018:	68 28 18 00 00       	push   $0x1828
  ...
  for(;;){
    ...
    1053:	68 30 18 00 00       	push   $0x1830
    1058:	6a 01                	push   $0x1
    ...
    10a4:	50                   	push   %eax
    10a5:	50                   	push   %eax
    10a6:	68 2c 1b 00 00       	push   $0x1b2c
...
00001403 <munprotect>:
SYSCALL(munprotect)
    1403:	b8 18 00 00 00       	mov    $0x18,%eax
    1408:	cd 40                	int    $0x40
    140a:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1644:	eb 1a                	jmp    1660 <printf+0x1a0>
          s = "(null)";
    1646:	bb 78 18 00 00       	mov    $0x1878,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1695:	a1 34 1b 00 00       	mov    0x1b34,%eax
{
    ...
    16b6:	73 10                	jae    16c8 <free+0x38>
{
  ...
  freep = p;
    ...
    16e1:	5b                   	pop    %ebx
  freep = p;
    16e2:	a3 34 1b 00 00       	mov    %eax,0x1b34
}
    16e7:	5e                   	pop    %esi
    16e8:	5f                   	pop    %edi
    16e9:	5d                   	pop    %ebp
  ...
  freep = p;
    170a:	a3 34 1b 00 00       	mov    %eax,0x1b34
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1730:	8b 3d 34 1b 00 00    	mov    0x1b34,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1779:	8b 3d 34 1b 00 00    	mov    0x1b34,%edi
  ...
  return freep;
    17a7:	a1 34 1b 00 00       	mov    0x1b34,%eax
    ...
    17d4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    17d7:	a3 34 1b 00 00       	mov    %eax,0x1b34
}
    ...
    base.s.ptr = freep = prevp = &base;
    17f0:	c7 05 34 1b 00 00 38 	movl   $0x1b38,0x1b34
    17f7:	1b 00 00 
    base.s.size = 0;
    17fa:	bf 38 1b 00 00       	mov    $0x1b38,%edi
    base.s.ptr = freep = prevp = &base;
    17ff:	c7 05 38 1b 00 00 38 	movl   $0x1b38,0x1b38
    1806:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1809:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    180b:	c7 05 3c 1b 00 00 00 	movl   $0x0,0x1b3c
    1812:	00 00 00 
    if(p->s.size >= nunits){
