    ...
    1058:	31 db                	xor    %ebx,%ebx
{
  ...
  write(fd, s, strlen(s));
    105d:	68 6c 14 00 00       	push   $0x146c
    1062:	e8 69 01 00 00       	call   11d0 <strlen>
    1067:	83 c4 0c             	add    $0xc,%esp
    106a:	50                   	push   %eax
    106b:	68 6c 14 00 00       	push   $0x146c
    1070:	6a 01                	push   $0x1
  ...
  write(fd, s, strlen(s));
    ...
    10bb:	68 9e 14 00 00       	push   $0x149e
    10c0:	e8 0b 01 00 00       	call   11d0 <strlen>
    10c5:	83 c4 0c             	add    $0xc,%esp
    10c8:	50                   	push   %eax
    10c9:	68 9e 14 00 00       	push   $0x149e
    10ce:	6a 01                	push   $0x1
  ...
  write(fd, s, strlen(s));
    ...
    10e2:	68 77 14 00 00       	push   $0x1477
    10e7:	e8 e4 00 00 00       	call   11d0 <strlen>
    10ec:	83 c4 0c             	add    $0xc,%esp
    10ef:	50                   	push   %eax
    10f0:	68 77 14 00 00       	push   $0x1477
    10f5:	6a 01                	push   $0x1
  ...
  write(fd, s, strlen(s));
    ...
    1104:	68 8b 14 00 00       	push   $0x148b
    1109:	e8 c2 00 00 00       	call   11d0 <strlen>
    110e:	83 c4 0c             	add    $0xc,%esp
    1111:	50                   	push   %eax
    1112:	68 8b 14 00 00       	push   $0x148b
    1117:	6a 01                	push   $0x1
  ...
  write(fd, s, strlen(s));
    ...
    1126:	68 ac 14 00 00       	push   $0x14ac
...
00001463 <munprotect>:
SYSCALL(munprotect)
    1463:	b8 18 00 00 00       	mov    $0x18,%eax
    1468:	cd 40                	int    $0x40
    146a:	c3                   	ret    
