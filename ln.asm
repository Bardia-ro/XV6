    ...
    100e:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  if(argc != 3){
    ...
    101b:	52                   	push   %edx
    101c:	52                   	push   %edx
    101d:	68 98 17 00 00       	push   $0x1798
    1022:	6a 02                	push   $0x2
  ...
  exit();
    ...
    104d:	68 ab 17 00 00       	push   $0x17ab
    1052:	6a 02                	push   $0x2
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    15b4:	eb 1a                	jmp    15d0 <printf+0x1a0>
          s = "(null)";
    15b6:	bb bf 17 00 00       	mov    $0x17bf,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1605:	a1 74 1a 00 00       	mov    0x1a74,%eax
{
    ...
    1626:	73 10                	jae    1638 <free+0x38>
{
  ...
  freep = p;
    167a:	a3 74 1a 00 00       	mov    %eax,0x1a74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16a0:	8b 3d 74 1a 00 00    	mov    0x1a74,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    16e9:	8b 3d 74 1a 00 00    	mov    0x1a74,%edi
  ...
  return freep;
    1717:	a1 74 1a 00 00       	mov    0x1a74,%eax
    ...
    1744:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    1747:	a3 74 1a 00 00       	mov    %eax,0x1a74
}
    ...
    base.s.ptr = freep = prevp = &base;
    1760:	c7 05 74 1a 00 00 78 	movl   $0x1a78,0x1a74
    1767:	1a 00 00 
    base.s.size = 0;
    176a:	bf 78 1a 00 00       	mov    $0x1a78,%edi
    base.s.ptr = freep = prevp = &base;
    176f:	c7 05 78 1a 00 00 78 	movl   $0x1a78,0x1a78
    1776:	1a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1779:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    177b:	c7 05 7c 1a 00 00 00 	movl   $0x0,0x1a7c
    1782:	00 00 00 
    if(p->s.size >= nunits){
