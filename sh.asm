...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
    ...
    102c:	6a 02                	push   $0x2
    102e:	68 09 23 00 00       	push   $0x2309
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    1048:	80 3d 42 29 00 00 20 	cmpb   $0x20,0x2942
...
fork1(void)
{
  ...
  exit();
    ...
    10a5:	68 40 29 00 00       	push   $0x2940
    10aa:	e8 01 0b 00 00       	call   1bb0 <strlen>
      if(chdir(buf+3) < 0)
    10af:	c7 04 24 43 29 00 00 	movl   $0x2943,(%esp)
      buf[strlen(buf)-1] = 0;  // chop \n
    10b6:	c6 80 3f 29 00 00 00 	movb   $0x0,0x293f(%eax)
      if(chdir(buf+3) < 0)
    ...
    10c9:	50                   	push   %eax
    10ca:	68 43 29 00 00       	push   $0x2943
    10cf:	68 11 23 00 00       	push   $0x2311
    10d4:	6a 02                	push   $0x2
    ...
    10f1:	68 40 29 00 00       	push   $0x2940
    ...
    1106:	68 92 22 00 00       	push   $0x2292
...
00001110 <getcmd>:
{
  ...
  printf(2, "$ ");
    ...
    1122:	68 68 22 00 00       	push   $0x2268
    1127:	6a 02                	push   $0x2
...
00001160 <panic>:
{
  ...
  printf(2, "%s\n", s);
    ...
    116d:	68 05 23 00 00       	push   $0x2305
    1172:	6a 02                	push   $0x2
...
00001180 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    119d:	3e ff 24 85 20 23 00 	notrack jmp *0x2320(,%eax,4)
    11a4:	00 
    if(pipe(p) < 0)
  ...
  if(pid == -1)
    ...
    1242:	68 72 22 00 00       	push   $0x2272
    1247:	6a 02                	push   $0x2
  ...
  if(pid == -1)
    ...
    12c4:	68 97 22 00 00       	push   $0x2297
    ...
    132d:	68 92 22 00 00       	push   $0x2292
...
00001340 <fork1>:
{
  ...
  return pid;
    ...
    1359:	68 92 22 00 00       	push   $0x2292
    ...
    14bd:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    14dd:	50                   	push   %eax
    14de:	68 30 29 00 00       	push   $0x2930
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    152d:	50                   	push   %eax
    152e:	68 30 29 00 00       	push   $0x2930
  ...
  *ps = s;
  ...
  if(eq)
    ...
    156e:	50                   	push   %eax
    156f:	68 28 29 00 00       	push   $0x2928
    ...
    1590:	56                   	push   %esi
    1591:	68 30 29 00 00       	push   $0x2930
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    163d:	50                   	push   %eax
    163e:	68 30 29 00 00       	push   $0x2930
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    16ab:	68 b9 22 00 00       	push   $0x22b9
    16b0:	53                   	push   %ebx
    16b1:	56                   	push   %esi
  ...
  return cmd;
    ...
    1736:	68 9c 22 00 00       	push   $0x229c
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
    1753:	68 bc 22 00 00       	push   $0x22bc
    1758:	57                   	push   %edi
    1759:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    17a6:	68 d3 22 00 00       	push   $0x22d3
    17ab:	57                   	push   %edi
    17ac:	56                   	push   %esi
    ...
    17f0:	68 c5 22 00 00       	push   $0x22c5
  ...
  cmd->eargv[argc] = 0;
    ...
    1842:	68 be 22 00 00       	push   $0x22be
...
00001850 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
    ...
    186d:	68 d8 22 00 00       	push   $0x22d8
  cmd = parseexec(ps, es);
...
000018c0 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
    ...
    1903:	68 da 22 00 00       	push   $0x22da
    1908:	57                   	push   %edi
    1909:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
    ...
    1919:	68 d6 22 00 00       	push   $0x22d6
    191e:	57                   	push   %edi
    191f:	56                   	push   %esi
...
00001970 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
    1983:	68 bc 22 00 00       	push   $0x22bc
    1988:	56                   	push   %esi
    1989:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
    ...
    19ad:	68 f8 22 00 00       	push   $0x22f8
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
    ...
    1a1d:	3e ff 24 85 38 23 00 	notrack jmp *0x2338(,%eax,4)
    1a24:	00 
...
00001ac0 <parsecmd>:
{
  ...
  peek(&s, es, "");
    ...
    1aeb:	68 81 22 00 00       	push   $0x2281
    1af0:	53                   	push   %ebx
    1af1:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    1b13:	52                   	push   %edx
    1b14:	50                   	push   %eax
    1b15:	68 fa 22 00 00       	push   $0x22fa
    1b1a:	6a 02                	push   $0x2
    1b1c:	e8 df 03 00 00       	call   1f00 <printf>
    panic("syntax");
    1b21:	c7 04 24 be 22 00 00 	movl   $0x22be,(%esp)
...
00001e43 <munprotect>:
SYSCALL(munprotect)
    1e43:	b8 18 00 00 00       	mov    $0x18,%eax
    1e48:	cd 40                	int    $0x40
    1e4a:	c3                   	ret    
    ...
    1e5c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    1e89:	0f b6 92 58 23 00 00 	movzbl 0x2358(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    2084:	eb 1a                	jmp    20a0 <printf+0x1a0>
          s = "(null)";
    2086:	bb 50 23 00 00       	mov    $0x2350,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    20d5:	a1 a4 29 00 00       	mov    0x29a4,%eax
{
    ...
    20f6:	73 10                	jae    2108 <free+0x38>
{
  ...
  freep = p;
    ...
    2121:	5b                   	pop    %ebx
  freep = p;
    2122:	a3 a4 29 00 00       	mov    %eax,0x29a4
}
    2127:	5e                   	pop    %esi
    2128:	5f                   	pop    %edi
    2129:	5d                   	pop    %ebp
  ...
  freep = p;
    214a:	a3 a4 29 00 00       	mov    %eax,0x29a4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    2170:	8b 3d a4 29 00 00    	mov    0x29a4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    21b9:	8b 3d a4 29 00 00    	mov    0x29a4,%edi
  ...
  return freep;
    21e7:	a1 a4 29 00 00       	mov    0x29a4,%eax
    ...
    2214:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    2217:	a3 a4 29 00 00       	mov    %eax,0x29a4
}
    ...
    base.s.ptr = freep = prevp = &base;
    2230:	c7 05 a4 29 00 00 a8 	movl   $0x29a8,0x29a4
    2237:	29 00 00 
    base.s.size = 0;
    223a:	bf a8 29 00 00       	mov    $0x29a8,%edi
    base.s.ptr = freep = prevp = &base;
    223f:	c7 05 a8 29 00 00 a8 	movl   $0x29a8,0x29a8
    2246:	29 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    2249:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    224b:	c7 05 ac 29 00 00 00 	movl   $0x0,0x29ac
    2252:	00 00 00 
    if(p->s.size >= nunits){
