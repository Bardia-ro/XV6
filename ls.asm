...
main(int argc, char *argv[])
{
  ...
  exit();
    ...
    104c:	68 c0 1a 00 00       	push   $0x1ac0
...
00001100 <ls>:
{
  ...
  close(fd);
    ...
    1195:	6a 02                	push   $0x2
    1197:	50                   	push   %eax
    1198:	68 a0 1a 00 00       	push   $0x1aa0
    119d:	6a 01                	push   $0x1
    ...
    *p++ = '/';
    ...
    12a1:	50                   	push   %eax
    12a2:	68 a0 1a 00 00       	push   $0x1aa0
    12a7:	6a 01                	push   $0x1
    ...
    12c3:	57                   	push   %edi
    12c4:	68 78 1a 00 00       	push   $0x1a78
    12c9:	6a 02                	push   $0x2
    ...
    12e3:	68 ad 1a 00 00       	push   $0x1aad
    12e8:	6a 01                	push   $0x1
    ...
    1303:	57                   	push   %edi
    1304:	68 8c 1a 00 00       	push   $0x1a8c
    1309:	6a 02                	push   $0x2
    ...
    132b:	57                   	push   %edi
    132c:	68 8c 1a 00 00       	push   $0x1a8c
    1331:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    1894:	eb 1a                	jmp    18b0 <printf+0x1a0>
          s = "(null)";
    1896:	bb c2 1a 00 00       	mov    $0x1ac2,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    18e5:	a1 04 1e 00 00       	mov    0x1e04,%eax
{
    ...
    1906:	73 10                	jae    1918 <free+0x38>
{
  ...
  freep = p;
    ...
    1931:	5b                   	pop    %ebx
  freep = p;
    1932:	a3 04 1e 00 00       	mov    %eax,0x1e04
}
    1937:	5e                   	pop    %esi
    1938:	5f                   	pop    %edi
    1939:	5d                   	pop    %ebp
  ...
  freep = p;
    195a:	a3 04 1e 00 00       	mov    %eax,0x1e04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1980:	8b 3d 04 1e 00 00    	mov    0x1e04,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    19c9:	8b 3d 04 1e 00 00    	mov    0x1e04,%edi
  ...
  return freep;
    19f7:	a1 04 1e 00 00       	mov    0x1e04,%eax
    ...
    1a24:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    1a27:	a3 04 1e 00 00       	mov    %eax,0x1e04
}
    ...
    base.s.ptr = freep = prevp = &base;
    1a40:	c7 05 04 1e 00 00 08 	movl   $0x1e08,0x1e04
    1a47:	1e 00 00 
    base.s.size = 0;
    1a4a:	bf 08 1e 00 00       	mov    $0x1e08,%edi
    base.s.ptr = freep = prevp = &base;
    1a4f:	c7 05 08 1e 00 00 08 	movl   $0x1e08,0x1e08
    1a56:	1e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1a59:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    1a5b:	c7 05 0c 1e 00 00 00 	movl   $0x0,0x1e0c
    1a62:	00 00 00 
    if(p->s.size >= nunits){
