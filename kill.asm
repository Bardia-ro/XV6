...
main(int argc, char **argv)
{
  ...
  exit();
    ...
    1051:	50                   	push   %eax
    1052:	50                   	push   %eax
    1053:	68 a8 17 00 00       	push   $0x17a8
    1058:	6a 02                	push   $0x2
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    15c4:	eb 1a                	jmp    15e0 <printf+0x1a0>
          s = "(null)";
    15c6:	bb bc 17 00 00       	mov    $0x17bc,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1615:	a1 74 1a 00 00       	mov    0x1a74,%eax
{
    ...
    1636:	73 10                	jae    1648 <free+0x38>
{
  ...
  freep = p;
    ...
    1661:	5b                   	pop    %ebx
  freep = p;
    1662:	a3 74 1a 00 00       	mov    %eax,0x1a74
}
    1667:	5e                   	pop    %esi
    1668:	5f                   	pop    %edi
    1669:	5d                   	pop    %ebp
  ...
  freep = p;
    168a:	a3 74 1a 00 00       	mov    %eax,0x1a74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16b0:	8b 3d 74 1a 00 00    	mov    0x1a74,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    16f9:	8b 3d 74 1a 00 00    	mov    0x1a74,%edi
  ...
  return freep;
    1727:	a1 74 1a 00 00       	mov    0x1a74,%eax
    ...
    1754:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    1757:	a3 74 1a 00 00       	mov    %eax,0x1a74
}
    ...
    base.s.ptr = freep = prevp = &base;
    1770:	c7 05 74 1a 00 00 78 	movl   $0x1a78,0x1a74
    1777:	1a 00 00 
    base.s.size = 0;
    177a:	bf 78 1a 00 00       	mov    $0x1a78,%edi
    base.s.ptr = freep = prevp = &base;
    177f:	c7 05 78 1a 00 00 78 	movl   $0x1a78,0x1a78
    1786:	1a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1789:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    178b:	c7 05 7c 1a 00 00 00 	movl   $0x0,0x1a7c
    1792:	00 00 00 
    if(p->s.size >= nunits){
